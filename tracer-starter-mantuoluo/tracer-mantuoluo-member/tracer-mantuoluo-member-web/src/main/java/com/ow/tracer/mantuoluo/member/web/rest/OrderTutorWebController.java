...
public class OrderTutorWebController extends BaseController {
    @Autowired
    private IOrderTutorService orderTutorService;
    private Logger logger = LoggerFactory.getLogger(OrderTutorWebController.class);
    ...
    public Result del(@PathVariable String  id) {
     ...
     /**
       ...
       */
       ...
       @PostMapping("/add")
       public Result add(@RequestBody OrderTutor  orderTutor ) {
           boolean  boo = orderTutorService.save(orderTutor);
           return Results.successWithData(boo, BaseEnums.SUCCESS.desc());
       }
     /**
       	 * 更新
       ...
       public Result edit(@RequestBody OrderTutor   orderTutor ,UserVO userVO){
        orderTutor .setUpdateDate(new Date());
        orderTutor .setUpdateBy(userVO.getId());
        orderTutor .setUpdater(userVO.getUserName());
        boolean boo = orderTutorService.updateById( orderTutor);
        return  Results.successWithData(boo,BaseEnums.SUCCESS.desc());
    }
