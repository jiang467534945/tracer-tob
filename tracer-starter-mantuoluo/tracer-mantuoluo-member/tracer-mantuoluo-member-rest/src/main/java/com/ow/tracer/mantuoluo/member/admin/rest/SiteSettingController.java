...
public class SiteSettingController extends BaseController {
    ...
    private Logger logger = LoggerFactory.getLogger(SiteSettingController.class);
    ...
    public Result del(@PathVariable String  id) {
     ...
     /**
       ...
       */
       ...
       @PostMapping("/add")
       public Result add(@RequestBody SiteSetting  siteSetting ,UserVO userVO) {
           boolean  boo = siteSettingService.save(siteSetting,userVO);
           return Results.successWithData(boo, BaseEnums.SUCCESS.desc());
       }
     /**
       	 * 更新
       ...
       public Result edit(@RequestBody SiteSetting   siteSetting ,UserVO userVO){
        ...
        boolean boo = siteSettingService.updateById( siteSetting,userVO);
        return  Results.successWithData(boo,BaseEnums.SUCCESS.desc());
    }
